...
public class SplashScreen extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/gui/onlinelogo.jpg"))); // NOI18N
    ...
    class SplashThread extends Thread
    {
        ...
        public void run()
        {
            ...
            while(jProgressBar1.getValue()< jProgressBar1.getMaximum())
            {
                ...
                {
                JOptionPane.showMessageDialog(null,"exception in thread" , "Thread exception", JOptionPane.ERROR_MESSAGE);
